...
export default function ToastMerge(props: Props) {
  const { color = 'darkGray', icon, text, thumbnailAlt, thumbnailHeight,  thumbnailWidth, thumbnailSrc} = props;
  let contents;
  // Confirmation Toasts
